...
public class TdxHqApi209912301
{
	...
	public static TdxHqApi2099 TdxHqApi20991230;
	public static void main(String[] args)
	{
		try
		{
			...
			boolean1=TdxHqLibrary1.TdxHq_Connect("61.49.50.190", 7709, Result, ErrInfo);
			if (!boolean1)
			{
...
//			System.out.println(Native.toString(Result, "GBK"));
			...
			// 获取财务数据
			boolean1= TdxHqLibrary1.TdxHq_GetFinanceInfo((byte)0, "000001", Result, ErrInfo);
			if (!boolean1)
			{
				System.out.println(Native.toString(ErrInfo, "GBK"));
				return;
...
//			//获取F10信息类别
//			//boolean  TdxHq_GetCompanyInfoCategory(byte Market, String Zqdm, byte[] Result, byte[] ErrInfo);
//			boolean1= TdxHqLibrary1.TdxHq_GetCompanyInfoCategory((byte)0, "000001", Result, ErrInfo);
//			if (!boolean1)
//			{
//				System.out.println(Native.toString(ErrInfo, "GBK"));
//				return;
